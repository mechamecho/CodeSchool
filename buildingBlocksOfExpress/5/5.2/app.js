...
/*Move the code from our previous app.get() route to a new GET route on the nameRoute object.*/
var nameRoute=app.route('/cities/:name');
nameRoute.get(function (request, response) {
...
/*move app.delete to nameRoute*/
nameRoute.delete(function (request, response) {
